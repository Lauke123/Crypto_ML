...
class Encoder(nn.Module):
    ...
    def forward(self, x, inputsize):
        ...
        # try to compine lugs und pin prediction in tensor to enable combined prediction
        ...
        # predict pins with good lug prediction again
        output = torch.cat((out,lugs),1)
        output = torch.transpose(output, 1, 2)
        ...
        lugs = self.combine_to_lugs(combined)
